...
public class BodyTransformerTest {
	...
	public void replaceVariableHolder() throws Exception {
		testTopLevelField("application/json", "{\"var\":1111}");
	}
	@Test
	public void replaceVariableHolderForXml() throws Exception {
		testTopLevelField("text/xml", "<root><var>1111</var></root>");
	}

	@Test
	public void replaceVariableHolderForUrlencoded() throws Exception {
		testTopLevelField("application/x-www-form-urlencoded", "var=1111&foo=bar");
	}

	private void testTopLevelField(String requestContentType, String requestBody)
	{
	...
	public void replaceNestedVariables() throws Exception {
		...
		testNestedField("application/json", requestBody);
	}
	@Test
	public void replaceNestedVariablesForXml() throws Exception {
		...
		testNestedField("text/xml", requestBody);
	}
//	@Test
//	public void replaceNestedVariablesForUrlencoded() throws Exception {
		//TODO nested support
//		final String requestBody = "var=1111&nested[attr]=found";
//		testNestedField("application/x-www-form-urlencoded", requestBody);
//	}

	private void testNestedField(String requestContentType, String requestBody)
	{
		wireMockRule.stubFor(post(urlEqualTo("/get/this"))
			.willReturn(aResponse()
				.withStatus(200)
